...
RAW_GEMINI_MODEL = (os.getenv("GEMINI_MODEL") or "gemini-1.5-flash").strip()
GEMINI_MODEL = RAW_GEMINI_MODEL if RAW_GEMINI_MODEL.startswith("gemini-") else "gemini-1.5-flash"
